...
rd_push_window_title(Arena *arena)
{
  ...
  String8 result = push_str8f(arena, "%S%s%s KFT " KFT_VERSION_STRING_LITERAL, project_name, project_name.size != 0 ? " - " : "", BUILD_TITLE " (" BUILD_VERSION_STRING_LITERAL " " BUILD_RELEASE_PHASE_STRING_LITERAL ")");
  return result;
}
