...
internal B32 kft_ev_type_key_matches_ffloat16_name(E_TypeKey type_key);

internal B32 kft_ev_pointer_should_emit_address_first(EV_StringParams *params, E_TypeKey type_key, E_TypeKind type_kind);
