...
struct NV_State
{
  ...
  // Pre-parsed NatVis hooks are rebuilt only when the cache generation changes.
  Arena *hook_map_arena;
  E_AutoHookMap natvis_auto_hook_map;
  B32 natvis_auto_hook_map_valid;
};
