...
#if defined(KFT_VERSION_STRING)
# define BUILD_KFT_VERSION_APPEND " [KFT " KFT_VERSION_STRING "]"
#else
# define BUILD_KFT_VERSION_APPEND ""
#endif

#define BUILD_TITLE_STRING_LITERAL BUILD_TITLE " (" BUILD_VERSION_STRING_LITERAL " " BUILD_RELEASE_PHASE_STRING_LITERAL ")" BUILD_KFT_VERSION_APPEND " - " __DATE__ "" BUILD_GIT_HASH_STRING_LITERAL_APPEND BUILD_MODE_STRING_LITERAL_APPEND
